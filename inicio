                ...
                {vacantesFiltradas.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {vacantesFiltradas.map((v) => (
                      <div
                        key={v.id}
                        className="bg-white rounded-xl border border-stone-200 overflow-hidden hover:shadow-md rc-anim transition-shadow relative flex flex-col"
                      >
                        ...
                        <div className="flex items-start gap-3 p-4">
                          {v.fotoUrl ? (
                            ...
                            <div className="w-12 h-12 rounded-lg bg-stone-100 flex items-center justify-center text-2xl shrink-0">
                              💼
                            </div>
                          )}
                          <div className="min-w-0">
                        ...
                        <div className="px-4 pb-4 flex items-center justify-between gap-2 mt-auto">
                          <span
                            className={`text-xs font-bold ${
                              v.salario ? "text-emerald-700" : "text-stone-400"
                            }`}
                          >
                            {v.salario || "Salario a convenir"}
                          </span>
                          <a
                            href={`mailto:${v.autorCorreo}?subject=${encodeURIComponent(
                              "Postulación: " + v.puesto
                            )}`}
                            className="px-3 py-1.5 rounded-lg bg-emerald-600 text-white text-xs font-semibold hover:bg-emerald-700 rc-anim transition-colors"
                          >
                            Postularme
                          </a>
                        </div>
